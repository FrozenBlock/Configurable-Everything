...
private val BIOME_KEY_MAP: TypedEntryType<MutableList<DimensionBiomeKeyMap>> = ConfigRegistry.register(
    TypedEntryType(
        MOD_ID,
        DimensionBiomeKeyMap.CODEC.mutListOf()
    )
)
...
"""
    ...
    @JvmField
    var replacedBiomes: TypedEntry<MutableList<DimensionBiomeKeyMap>> = TypedEntry.create(
        BIOME_KEY_MAP,
        mutableListOf(
